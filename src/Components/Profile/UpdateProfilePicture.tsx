...
export const UpdateProfilePicture = () => {
  ...
  const [previewUrl, setPreviewUrl] = useState("https://cdn-icons-png.flaticon.com/128/149/149071.png");
  ...
  if (userLoading || !user?.user?.email) {
    ...
    try {
     ...
     formdata.append("file", file);
      ...
      await updateProfile({ profileImage: imageUrl, email: user?.user?.email }).unwrap();
